...
//For this assignment, you will write a program that simulates a fishing game. In this game,
//a six-sided die is rolled to determine what the user has caught. Each possible item is worth
//a certain number of fishing points. The points will remain hidden until the user is finished
//fishing, and then a message is displayed congratulating the user, depending on the number
...
//she wants to continue fishing.
//• The program simulates the rolling of a six-sided die (use the Die class that was shown
//in Code Listing 6-14).
